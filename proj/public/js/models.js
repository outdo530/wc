...
var m_route = {
    ...
    sub_func: [
        ...
        {id: 40, url: '/user__customer_update/:crud_id',   templateUrl: 'template/crud_update_visit_log.html',   controller:'crudUpdateCtrl_user_customer' },
        {id: 41, url: '/user__customer_create',            templateUrl: 'template/crud_create_visit_log.html',   controller:'crudCreateCtrl_user_customer' },
