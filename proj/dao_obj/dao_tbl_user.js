...
function Tbl_user(){
    ...
    Tbl_user.info = {
        ...
        struct : {
	        ...
	        epm_no: { key: 'emp_no',  key_text: '雇员号', key_type: 'label', value_def: '', value_type: 'text', is_col:1, is_to_set:1,  is_list:1, is_detail:1 },
	        real_nm: { key: 'real_nm',  key_text: '真实姓名', key_type: 'label', value_def: '', value_type: 'text', is_col:1, is_to_set:1,  is_list:1, is_detail:1},
	        gender: { key: 'gender',  key_text: '性别', key_type: 'label', value_def: '', value_type: 'text', is_col:1, is_to_set:1,  is_list:1, is_detail:1},
	        email: { key: 'email',  key_text: '邮件地址', key_type: 'label', value_def: '', value_type: 'text', is_col:1, is_to_set:1,  is_list:1, is_detail:1  },
	        mobile: { key: 'mobile',  key_text: '手机', key_type: 'label', value_def: '', value_type: 'text', is_col:1, is_to_set:1,  is_list:1, is_detail:1 },
	        fix_phone: { key: 'fix_phone',  key_text: '固话', key_type: 'label', value_def: '', value_type: 'text', is_col:1, is_to_set:1,  is_list:1, is_detail:1 },
	        id_card_no: { key: 'id_card_no',  key_text: '身份证', key_type: 'label', value_def: '', value_type: 'text', is_col:1, is_to_set:1,  is_list:1, is_detail:1 },
	        enter_date: { key: 'enter_date',  key_text: '入司日期', key_type: 'label', value_def: '', value_type: 'text', is_col:1, is_to_set:1,  is_list:1, is_detail:1 },
	        left_date: { key: 'left_date',  key_text: '离司日期', key_type: 'label', value_def: '', value_type: 'text', is_col:1, is_to_set:1,  is_list:1, is_detail:1 },
	        user_type: { key: 'user_type',  key_text: '用户类型', key_type: 'label', value_def: '', value_type: 'text', is_col:1, is_to_set:1,  is_list:1, is_detail:1 },
	        sign_id: { key: 'sign_id',  key_text: '登录id', key_type: 'label', value_def: '', value_type: 'text', is_col:1, is_to_set:1,  is_list:1, is_detail:1 },
	        nick_nm: { key: 'nick_nm',  key_text: '昵称', key_type: 'label', value_def: '', value_type: 'text', is_col:1, is_to_set:1,   is_list:1, is_detail:1},
