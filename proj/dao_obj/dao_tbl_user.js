    ...
    Tbl_user.info = {
        ...
        struct : {
	        ...
	        fix_phone: { key: 'fix_phone',  key_text: '固话', key_type: 'label', value_def: '', value_type: 'text', 
                is_col:1, is_to_set:1,  is_list:1, is_detail:1, op: tbl_const.op_type_text(), },
	        id_card_no: { key: 'id_card_no',  key_text: '身份证', key_type: 'label', value_def: '', value_type: 'text', 
                is_col:1, is_to_set:1,  is_list:1, is_detail:1, op: tbl_const.op_type_text(), },
	        enter_date: { key: 'enter_date',  key_text: '入司日期', key_type: 'label', value_def: '', value_type: 'text', 
                is_col:1, is_to_set:1,  is_list:1, is_detail:1, op: tbl_const.op_type_text(), },
	        left_date: { key: 'left_date',  key_text: '离司日期', key_type: 'label', value_def: '', value_type: 'text', 
                is_col:1, is_to_set:1,  is_list:1, is_detail:1, op: tbl_const.op_type_text(), },
	        ...
	        nick_nm: { key: 'nick_nm',  key_text: '昵称', key_type: 'label', value_def: '', value_type: 'text', 
                is_col:1, is_to_set:1,   is_list:1, is_detail:1, op: tbl_const.op_type_text(),},
	        password: { key: 'password',  key_text: '登录密码', key_type: 'label', value_def: '', value_type: 'text', 
